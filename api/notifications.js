    ...
    try {
      const rows = await sql`
        INSERT INTO notifications (
          tenant_id, title, message, notification_type,
          severity, category, related_id
        ) VALUES (
          ${user.tenantId}, ${b.title}, ${b.message || null},
          ${b.notificationType || 'info'}, ${b.severity || 'low'},
          ${b.category || null}, ${b.relatedId || null}
        ) RETURNING *
      `;
